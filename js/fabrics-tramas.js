/* Auto-gerado: dados de tecidos TRAMAS */
const FABRICS_TRAMAS = {
  MACRAME_PALMER: {
    name: 'Macramê Franja Palmer', category: 'TRAMAS', tag: 'Moda Praia · Moda Casual',
    previewColors: ['#c2b59e', '#997d77', '#000000', '#5e8272'],
    desc: 'Malha jacquard com efeito macramê e acabamento em franjas, que traz movimento e personalidade à peça. Sua estrutura de tramas abertas combinada ao toque macio proporciona um visual artesanal com apelo moderno, ideal para criações que valorizam textura e leveza. Com composição em poliamida com elastano, oferece conforto, flexibilidade e ótimo caimento. Perfeita para moda praia e casual, especialmente em peças como saídas, vestidos e sobreposições que exploram o efeito fluido das franjas.',
    pages: 1, colorsTitle: 'Variações',
    colors:[
      { name: 'Bege/Kraft', hex:'#c2b59e' },
      { name: 'Castanho  Charuto', hex:'#997d77'},
      { name: 'Preto', hex:'#000000'},
      { name: 'Verde/Pantano', hex:'#5e8272'},
    ],
  ...
  MACRAME: {
    ...
    bookUrl: 'book.html?fabric=MACRAME',
  },
  TELA_FIT_POLIESTER: {
    ...
    colors:[
      ...
      { name: 'Branco', hex:'#ffff'},
      { name: 'Marinho', hex: '#2e3861'},
      { name: 'Marsala', hex: '#a42941'}
