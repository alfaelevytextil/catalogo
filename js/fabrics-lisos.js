...
CORTA_VENTO_REFLETIVO: {
  ...
  previewColors: ['#9a9c9d'],
  desc: '', 
  pages: '', colorsTitle: 'Cores Disponíveis',
  colors: [
   { name: 'cor única: Cinza', hex: '#9a9c9d' },
  ],
  largura: '', rendimento: '', gramatura: '', composicao: '', 
  attributes: [],
...
DEMI: {
  ...
  colors: [
    ...
    { name: 'Spoonbill', hex: '#ffd3dd' },
    { name: 'Bulbous Yellow', hex: '#f6e597' },
    { name: 'Romantic', hex: '#fce3db' },
...
DRY_SPORT: {
  ...
  FORRO_TRADICIONAL: {
    ...
    previewColors: ['#a32360', '#ffffff', '#87CEEB', '#baa49d', '#000000'],
...
bookUrl: 'book.html?fabric=NAGOYA',
 ...
 SATURNO: {
    ...
    desc: 'Poliamida opaca com elastano ideal para peças com proteção solar, tanto na linha praia quanto performance. Perfeito para forro em peças da linha praia. Por ser uma base leve e fluida, pode ser utilizado em blusas, biquinis ou saídas de praia com babados e drapeados. A variante PAINT leva o selo sustentável GREEN FIBER, pois é apenas LAVADA e não sofre tingimento, economizando até 70% de água e energia elétrica em seu processo. SATURNO ROCK SOLID COLORS recebe tingimento ESPECIAL, um processo exclusivo SPA onde a cor possui ALTA SOLIDEZ à lavagem até 40ºC. É preciso respeitar as condições descritas na Ficha Técnica do produto. FPU 50+ vitalício devido ao fio de poliamida ser enriquecido com dióxido de titânio em sua massa. Possui certificação OEKO-TEX, garantindo que não há químicos nocivos aos usuários em sua fabricação.',
    pages: 1, colorsTitle: 'Cores Disponíveis',
    colors: [
...
TRILOBAL_BEACH: {
  ...
  { name: '2109 Callas', hex: '#b4504a'},
  { name: '3950 Carmim', hex: '#72142a' },
  { name: '6811 Carbox', hex: ' #464a4d' },
  { name: '5800 Cappuccino', hex: '#5b3325' },
  { name: '3272 Castanho', hex: '#2b2b20' },
  { name: '8219 Caramelo', hex: '#bf6e16' },
  { name: '1818 Chic Red', hex: '#bb1a20' },
  { name: '3621 Cítrus', hex: '#ccda78' },
  { name: '3002 Chocolate', hex: '#baa49d' },
  ...
  { name: '0320 Enseada', hex: '#1583e0' },
  { name: '9161 Esmeralda', hex: '#243a45' },
  { name: '9158 Eucalipto', hex: '#5f7c6b' },
  { name: '7988 Euforia', hex: '#e4407e' },
  ...
  { name: '3602 Ipanema', hex: '#c25e3c'},
  { name: '3930 Jade', hex: '#008f7f' },
  { name: '3495 Lavanda', hex: '#a47ee0' },
  { name: '2879 Líris', hex: '#bc4869'},
  { name: '3183 Líquor', hex: '#ac2e27' },
  ...
  { name: '3886 Náutico', hex: '#3e649a' },
  { name: '3840 Netuno', hex: '#4a476d' },
  { name: '4319 Nilo', hex: '#21476b' },
  { name: '8275 Oceano', hex: '#3848a0' },
  { name: '1878 Olinda', hex: '#e42a67' },
  { name: '8340 Off-White', hex: '#eae4d3' },
  { name: '5806 Palace', hex: '#1b2e32' },
  { name: '9227 Plánetario',    hex: '#2a408f' },
  { name: '3122 Páprica', hex: '#ae4c21' },
  { name: '0542 Pérola', hex: '#fbfbe7' },
  { name: '4890 Pistache', hex: '#7a722a' },
  ...
  { name: '2209 Rosa Choque', hex: '#e3307b' },
  { name: '3627 Satin', hex: '#775a5f' },
  { name: '0396 Shark', hex: '#203e4a' },
  { name: '3497 Sky', hex: '#7bb1cd' },
  { name: '4643 Skyblue', hex: '#1cb1c6' },
  { name: '8170 Sálvia', hex: '#50826f' },
  { name: '6238 Sirena', hex: '#20b8a2' },
  { name: '3919 Sophia', hex: '#a664ad' },
  { name: '5178 Spirit', hex: '#e5fd47' },
  { name: '5992 Submarine', hex: '#002c41' },
  { name: '0801 Sun Kisses', hex: '#e2d487' },
  { name: '0611 Tangerina', hex: '#e25b26' },
  { name: '6240 Tâmisa', hex: '#415a7a' },
  { name: '3489 Terracota', hex: '#d06a4f' },
  { name: '8310 Twist', hex: '#00c96e'},
  { name: '9164 Verbena', hex: '#83627d' },
  { name: '4325 Vert', hex: '#53b75c' },
  { name: '3598 Vulcano', hex: '#1e1916' },
  { name: '1343 Zig Zag', hex: '#f09189' },
