...
const FABRICS_TEXTURIZADOS = {
  ...
  LUREX_3_PRATA: {
    ...
    colors: [
      ...
      { name: 'Verde Musgo', hex: '#6A7A48' },
      { name: 'Oliva', hex: '#7A7040' },
      { name: 'Amarelo Ouro', hex: '#D4A820' },
      { name: 'Amarelo', hex: '#E8DC7A' },
      { name: 'Laranja Terra', hex: '#C85020' },
      { name: 'Laranja', hex: '#D96020' },
      { name: 'Coral', hex: '#E07060' },
      { name: 'Salmão', hex: '#E09878' },
      { name: 'Rosa Antigo', hex: '#C07880' },
      { name: 'Rosa', hex: '#D47888' },
      { name: 'Rosa Chiclete', hex: '#E04888' },
      { name: 'Rosa Bebê', hex: '#F0B8C8' },
    ],
