...
const FABRICS = {
  ...
  LIRUS: {
    ...
    colors: [
      ...
      { name: 'Cinza Claro',  hex: '#C0BDB8' },
      { name: 'Cinza',        hex: '#888480' },
      { name: 'Preto',        hex: '#151210' },
      { name: 'Marinho',      hex: '#1A2346' },
      { name: 'Verde Musgo',  hex: '#3E6040' },
      { name: 'Laranja',      hex: '#D95C1A' },
      { name: 'Coral',        hex: '#E07060' },
      { name: 'Rosa',         hex: '#D4788A' },
