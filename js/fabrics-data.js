/* ═══════════════════════════════════════════════════════════════
   ...
   CHAVE: {
     ...
     cover       : 'images/tecidos/LISOS/CHAVE/cover.jpg', // opcional — imagem limpa para o modal
     //   Se não definido, usa page-01.jpg como capa.
     //   Nomeie o arquivo como quiser (ex: cover.jpg, foto-limpa.jpg, etc.)
     //
     // ► CORES SEM FOTO (chips CSS — site mais leve):
     //   Se "colors" estiver definido, o modal mostra quadradinhos coloridos (sem foto).
     //   Use pages:1 (só a capa) quando optar por chips.
     //   ESTAMPADOS e VARIAÇÕES COM FOTO: NÃO use colors — mantenha pages normalmente.
     //
     colors: [                                // opcional
...
const FABRICS = {
  ...
  // ── LISOS ────────────────────────────────────────────────────
  CIRRE: {
    name: 'Cirré', category: 'LISOS', tag: 'Moda Praia · Moda Casual',
...
DRY_SPORT: {
  ...
  FORRO_COLMEIA: {
    name: 'Forro Colmeia', category: 'LISOS', tag: 'Moda Praia · Moda Casual',
  ...
  FORRO_TRADICIONAL: {
    name: 'Forro Tradicional', category: 'LISOS', tag: 'Moda Praia · Moda Casual',
...
SANTA_CONSTANCIA: {
  ...
  NEW_TRIP: {
    ...
    colors: [
      { name: 'Acalanto',         hex: '#7FB8AD' },
      { name: 'Alecrim',      hex: '#719273' },
      { name: 'Atlantis',    hex: '#66bfb5' },
      { name: 'Atol',    hex: '#04839b' },
      { name: 'Barolo',   hex: '#492026' },
      { name: 'Bikini',          hex: '#bb4f8c' },
      { name: 'Bonsai',        hex: '#354335' },
      { name: 'Branco',     hex: '#ffffff' },
      { name: 'Cappuccino',   hex: '#5b3325' },
      { name: 'Castanho',hex: '#b5a186' },
      { name: 'Chic red',  hex: '#bb1a20' },
      { name: 'Cítrus',    hex: '#ccda78' },
      { name: 'Conhaque',          hex: '#a36648' },
      { name: 'Croco',        hex: '#424f3c' },
      { name: 'Desejo',  hex: '#89052f' },
      { name: 'Drink',          hex: '#40d68f' },
      { name: 'Electra',  hex: '#ff104f' },
      { name: 'Energia',      hex: '#f29e73' },
      { name: 'Euforia',       hex: '#e4407e' },
      { name: 'Flash',          hex: '#a4f21c' },
      { name: 'Foliage',          hex: '#2c4726' },
      { name: 'Frais',           hex: '#b1f5e0' },
      { name: 'Fuchsia',          hex: '#7d336b' },
      { name: 'Galápagos',        hex: '#23503e' },
      { name: 'Galáxia',       hex: '#384c67' },
      { name: 'Gris',         hex: '#808484' },
      { name: 'Laguna',      hex: '#519198' },
      { name: 'Lavanda',      hex: '#a47ee0' },
      { name: 'Marinho',         hex: '#0f1c2e' },
      { name: 'Melissa',          hex: '#c38db7' },
      { name: 'Mirante',         hex: '#77b8c9' },
      { name: 'Náutico',        hex: '#3e649a' },
      { name: 'Netuno',          hex: '#4a476d' },
      { name: 'Pácifico',           hex: '#707e9b' },
      { name: 'Peter Pan',         hex: '#378764' },
      { name: 'Pólen',        hex: '#f7c874' },
      { name: 'Preto',      hex: '#000000' },
      { name: 'Romance',        hex: '#e59898' },
      { name: 'Rosa Choque',       hex: '#e3307b' },
      { name: 'Safira',       hex: '#244782' },
      { name: 'Sky',       hex: '#7bb1cd' },  
  ...
  LUNA: {
    name: 'Luna', category: 'LISOS', tag: 'Moda Praia · Moda Casual',
    ...
    colors: [
      ...
      { name: 'Avelã', hex: '#a47b67' },
      { name: 'Atlantis',    hex: '#66bfb5' },
      { name: 'Atol',    hex: '#04839b' },
      { name: 'Base',        hex: '#d4c2bc' },
      { name: 'Barolo',   hex: '#492026' },
      { name: 'Bikini',          hex: '#bb4f8c' },
      { name: 'Bliss', hex: '#ea88b1' },
      { name: 'Blossom', hex: '#e298ae' },
      { name: 'Blue Jeans', hex: '#3c5577' },
      { name: 'Bonsai',        hex: '#354335' },
      { name: 'Branco',     hex: '#ffffff' },
      { name: 'Botânico', hex: '#5b8643' },
      { name: 'Carmim', hex: '#72142a' },
      { name: 'Cappuccino',   hex: '#5b3325' },
      { name: 'Castanho',hex: '#2b2b20' },
      { name: 'Caramelo', hex: '#bf6e16' },
      { name: 'Celeste', hex: '#5d82a0' },
      { name: 'Chic red',  hex: '#bb1a20' },
      { name: 'Cítrus',    hex: '#ccda78' },
      { name: 'Chocolate',          hex: '#baa49d' },
      { name: 'Coffee', hex: '#291d03' },
      { name: 'Conhaque',          hex: '#a36648' },
      { name: 'Croco',        hex: '#424f3c' },
      { name: 'Cromo', hex: '#9a9c9d' },
      { name: 'Desejo',  hex: '#89052f' },
      { name: 'Delicati ' ,  hex: '#d2bca6' },
      { name: 'Deluxe', hex: '#44192f' },
      { name: 'Divino', hex: '#801726' },
      { name: 'Drink',          hex: '#40d68f' },
      { name: 'Electra',  hex: '#ff104f' },
      { name: 'Energia',      hex: '#f29e73' },
      { name: 'Enseada', hex: '#1583e0' },
      { name: 'Euforia',       hex: '#e4407e' },
      { name: 'Flash',          hex: '#a4f21c' },
      { name: 'Folia', hex: '#ee0b1e' },
      { name: 'Foliage',          hex: '#2c4726' },
      { name: 'Frais',           hex: '#b1f5e0' },
      { name: 'Frash',          hex: '#a0d0a0' },
      { name: 'Fuchsia',          hex: '#7d336b' },
      { name: 'Gaia',        hex: '#932e68' },
      { name: 'Galápagos',        hex: '#23503e' },
      { name: 'Galáxia',       hex: '#384c67' },
      { name: 'Girassol',        hex: '#f8c200' },
      { name: 'Gris',         hex: '#808484' },
      { name: 'Harmonia', hex: '#a47bb3' },
      { name: 'Hortênsia',      hex: '#606693' },
      { name: 'Jade', hex: '#008f7f' },
      { name: 'Laguna',      hex: '#519198' },
      { name: 'Lavanda',      hex: '#a47ee0' },
      { name: 'Líquor', hex: '#ac2e27' },
      { name: 'Magenta', hex: '#dd1750' },
      { name: 'Mango', hex: '#f97e10' },
      { name: 'Marinho',         hex: '#0f1c2e' },
      { name: 'Mel',   hex: '#f2a830' },
      { name: 'Melissa',          hex: '#c38db7' },
      { name: 'Melon', hex: '#cebb45' },
      { name: 'Menta', hex: '#b8f2a5' },
      { name: 'Milkshake',          hex: '#e06eac' },
      { name: 'Mirante',         hex: '#77b8c9' },
      { name: 'Morango', hex: '#cc3f4a' },
      { name: 'Nannai', hex: '#1bacb5' },
      { name: 'Náutico',        hex: '#3e649a' },
      { name: 'Netuno',          hex: '#4a476d' },
      { name: 'Oceano', hex: '#3848a0' },
      { name: 'Oliva', hex: '#b7cd9b' },
      { name: 'Olinda', hex: '#e42a67' },
      { name: 'Off White', hex: '#eae4d3' },
      { name: 'Pácifico',           hex: '#707e9b' },
      { name: 'Paradiso',         hex: '#63a7bd' },
      { name: 'Páprica',         hex: '#ae4c21' },
      { name: 'Pérola',        hex: '#fbfbe7' },
      { name: 'Pistache', hex: '#7a722a' },
      { name: 'Peter Pan',         hex: '#378764' },
      { name: 'Pólen',        hex: '#f7c874' },
      { name: 'Preto',      hex: '#000000' },
      { name: 'Púrpura', hex: '#451343' },
      { name: 'Romã', hex: '#b63754' },
      { name: 'Romance',        hex: '#e59898' },
      { name: 'Rosa Choque',       hex: '#e3307b' },
      { name: 'Safira',       hex: '#244782' },
      { name: 'Satin',        hex: '#775a5f' },
      { name: 'Sky',       hex: '#7bb1cd' },  
      { name: 'Skyblue',      hex: '#1cb1c6' },
      { name: 'Sálvia',        hex: '#50826f' },
      { name: 'Siciliano',        hex: '#e2dd85' },
      { name: 'Sophia', hex: '#a664ad' },
      { name: 'Spirit',      hex: '#bdcf4c' },
      { name: 'Sun Kisses',      hex: '#e2d487' },
      { name: 'Tangerina',        hex: '#e25b26' },
      { name: 'Tâmisa', hex: '#415a7a' },
      { name: 'Terracota',       hex: '#d06a4f' },
      { name: 'Ultrapink',        hex: '#ff4d80' },
      { name: 'Vereda',        hex: '#959e3f' },
      { name: 'Viena',      hex: '#773645' },
      { name: 'Zig Zag',     hex: '#f09189' },
    ],
    largura: '1,60m', rendimento: '4,57m/kg', gramatura: '135g/m²', composicao: '91% Poliamida, 9% Elastano',
  ...
  DOTS: {
    ...
    colors: [
      ...
      { name: 'Vermelho', hex: '#CC2828' },
      { name: 'Bordô', hex: '#8C1820' },
    ],
  },
  JACQUARD_BROCADO: {
  ...
  MALTE: {
    ...
    pages: 1, colorsTitle: 'Cores Disponíveis',
    colors: [
      { name: 'Bege e Branco', hex: '#aeaa9c, #FFFFFF' },
      { name: 'Off-White', hex: '#F0EBD8' },
      { name: 'Areia', hex: '#E8DEC8' },
      { name: 'Marfim', hex: '#EDE0C4' },
      { name: 'Bege', hex: '#D8C8A8' },
